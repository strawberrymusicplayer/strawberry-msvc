...
- **Required**:
    ...
    - Extract `VSYASM.zip`
        - Start `x64 Native Tools Command Prompt` as `Administrator` and run `install_script.bat`
            - This copies `yasm.props`, `yasm.targets` and `yasm.xml` to:
              - Visual Studio 2026: `C:\Program Files\Microsoft Visual Studio\18\Community\MSBuild\Microsoft\VC\v180\BuildCustomizations`, or
              - Visual Studio 2022: `C:\Program Files\Microsoft Visual Studio\2022\Community\MSBuild\Microsoft\VC\v170\BuildCustomizations`
            - And `yasm-64.exe` to:
              - Visual Studio 2026: `C:\Program Files\Microsoft Visual Studio\18\Community\VC\yasm.exe`, or
              - Visual Studio 2022: `C:\Program Files\Microsoft Visual Studio\2022\Community\VC\yasm.exe`
