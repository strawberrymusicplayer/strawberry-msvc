...
https://lib.openmpt.org/files/libopenmpt/src/libopenmpt-0.7.0+release.msvc.zip
...
https://gstreamer.freedesktop.org/src/gst-plugins-good/gst-plugins-good-1.22.2.tar.xz
