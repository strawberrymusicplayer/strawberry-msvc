...
https://download.gnome.org/sources/glib/2.72/glib-2.72.1.tar.xz
...
https://raw.githubusercontent.com/strawberrymusicplayer/strawberry-msvc-dependencies/master/patches/qtbase-pcre2.patch
