...
@if not exist "%PREFIX_PATH%\lib\gstreamer-1.0\gstspotify.dll" goto gst-plugins-rs
...
cd "%BUILD_PATH%" || goto end
if not exist "icu" tar -xvf "%DOWNLOADS_PATH%\icu4c-%ICU4C_VERSION%-sources.tgz" || goto end
...
call .\bootstrap.bat msvc || goto end
...
echo Version: %SQLITE_VERSION%>> "%PREFIX_PATH%/lib/pkgconfig/sqlite3.pc"
...
@echo Version: %FAAC_VERSION%>> "%PREFIX_PATH%\lib\pkgconfig\faac.pc"
