...
@SET SOURCES_PATH=c:\data\projects\strawberry\msvc_\sources
...
@if not exist "%SOURCES_PATH%" MKDIR "%SOURCES_PATH%" || goto end
...
copy /y "%SOURCES_PATH%\yasm-1.3.0-win64.exe" "%PREFIX_PATH%\bin\yasm.exe"
...
cd "%BUILD_PATH%"
if not exist "boost_1_79_0" tar -xvf "%SOURCES_PATH%\boost_1_79_0.tar.bz2" || goto end
...
if not exist "pkgconf-pkgconf-1.8.0" tar -xvf "%SOURCES_PATH%\pkgconf-1.8.0.tar.gz" || goto end
...
if not exist "zlib-1.2.12" tar -xvf "%SOURCES_PATH%\zlib-1.2.12.tar.gz" || goto end
...
cd "%BUILD_PATH%" || goto end
if not exist "openssl-3.0.2" tar -xvf "%SOURCES_PATH%\openssl-3.0.2.tar.gz" || goto end
cd openssl-3.0.2 || goto end
...
cd gnutls || goto end
7z x -aoa "%SOURCES_PATH%\libgnutls_3.7.3_msvc16.zip" || goto end
...
cd "%BUILD_PATH%"
if not exist "libpng-1.6.37" tar -xvf "%SOURCES_PATH%\libpng-1.6.37.tar.gz" || goto end
cd "libpng-1.6.37" || goto end
patch -p1 -N < "%SOURCES_PATH%/libpng-msvc.patch"
...
cd "%BUILD_PATH%"
if not exist "bzip2-1.0.8" tar -xvf "%SOURCES_PATH%\bzip2-1.0.8.tar.gz" || goto end
cd bzip2-1.0.8 || goto end
patch -p1 -N < "%SOURCES_PATH%/bzip2-cmake.patch"
...
cd "%BUILD_PATH%"
if not exist "xz-5.2.5" tar -xvf "%SOURCES_PATH%\xz-5.2.5.tar.bz2" || goto end
...
cd "%BUILD_PATH%"
if not exist "brotli-1.0.9" tar -xvf "%SOURCES_PATH%\v1.0.9.tar.gz" || goto end
...
if not exist "libiconv-for-Windows" @(
  ...
  xcopy /s /y /h "%SOURCES_PATH%\libiconv-for-Windows" . || goto end
  cd ..
) || goto end
cd libiconv-for-Windows || goto end
git checkout 9b7aba8da6e125ef33912fa4412779279f204003 || goto end
...
cd "%BUILD_PATH%"
if not exist "pixman-0.40.0" tar -xvf "%SOURCES_PATH%\pixman-0.40.0.tar.gz" || goto end
...
cd "%BUILD_PATH%"
if not exist "libxml2-v2.9.13" tar -xvf "%SOURCES_PATH%\libxml2-v2.9.13.tar.bz2"
cd "libxml2-v2.9.13" || goto end
if not exist build mkdir build || goto end
cd build || goto end
...
cd "%BUILD_PATH%"
if not exist "nghttp2-1.47.0" tar -xvf "%SOURCES_PATH%\nghttp2-1.47.0.tar.bz2" || goto end
cd "nghttp2-1.47.0" || goto end
if not exist build mkdir build || goto end
cd build || goto end
...
cd "%BUILD_PATH%"
if not exist "sqlite-autoconf-3380200" tar -xvf "%SOURCES_PATH%\sqlite-autoconf-3380200.tar.gz" || goto end
cd "sqlite-autoconf-3380200" || goto end
...
cd "%BUILD_PATH%"
if not exist "libogg-1.3.5" tar -xvf "%SOURCES_PATH%\libogg-1.3.5.tar.gz" || goto end
...
cd "%BUILD_PATH%"
if not exist "libvorbis-1.3.7" tar -xvf "%SOURCES_PATH%\libvorbis-1.3.7.tar.gz" || goto end
...
cd "%BUILD_PATH%"
if not exist "flac-1.3.4" 7z x "%SOURCES_PATH%\flac-1.3.4.tar.xz" -so | 7z x -aoa -si"flac-1.3.4.tar" || goto end
...
cd "%BUILD_PATH%"
if not exist "wavpack-5.4.0" tar -xvf "%SOURCES_PATH%\wavpack-5.4.0.tar.bz2" || goto end
...
cd "%BUILD_PATH%"
if not exist "opus-1.3.1" tar -xvf "%SOURCES_PATH%\opus-1.3.1.tar.gz" || goto end
...
cd "%BUILD_PATH%"
if not exist "opusfile-0.12" tar -xvf "%SOURCES_PATH%\opusfile-0.12.tar.gz" || goto end
cd "opusfile-0.12" || goto end
patch -p1 -N < "%SOURCES_PATH%/opusfile-cmake.patch"
if not exist build mkdir build || goto end
cd build || goto end
cmake .. -G "NMake Makefiles" -DCMAKE_BUILD_TYPE="%BUILD_TYPE%" -DCMAKE_INSTALL_PREFIX="%PREFIX_PATH%" -DBUILD_SHARED_LIBS=ON || goto end
cmake --build . || goto end
...
if not exist "speex" @(
  ...
  cd speex || goto end
  xcopy /s /y /h "%SOURCES_PATH%\speex" . || goto end
  cd .. || goto end
) || goto end
cd "speex" || goto end
patch -p1 -N < "%SOURCES_PATH%/speex-cmake.patch"
if not exist build mkdir build || goto end
cd build || goto end
cmake .. -G "NMake Makefiles" -DCMAKE_BUILD_TYPE="%BUILD_TYPE%" -DCMAKE_INSTALL_PREFIX="%PREFIX_PATH%" -DBUILD_SHARED_LIBS=ON || goto end
cmake --build . || goto end
...
cd "%BUILD_PATH%"
if not exist "mpg123-1.29.3" tar -xvf "%SOURCES_PATH%\mpg123-1.29.3.tar.bz2" || goto end
cd "mpg123-1.29.3" || goto end
if not exist build2 mkdir build2 || goto end
cd build2 || goto end
...
cd "%BUILD_PATH%"
if not exist "lame-3.100" tar -xvf "%SOURCES_PATH%\lame-3.100.tar.gz" || goto end
...
cd "%BUILD_PATH%"
if not exist "taglib-1.12" tar -xvf "%SOURCES_PATH%\taglib-1.12.tar.gz" || goto end
...
cd "%BUILD_PATH%"
if not exist "dlfcn-win32-1.3.0" tar -xvf "%SOURCES_PATH%\v1.3.0.tar.gz" || goto end
...
cd "%BUILD_PATH%"
if not exist "fftw-3.3.10" tar -xvf "%SOURCES_PATH%\fftw-3.3.10.tar.gz" || goto end
cd "fftw-3.3.10" || goto end
if not exist build mkdir build || goto end
cd build || goto end
cmake .. -G "NMake Makefiles" -DCMAKE_BUILD_TYPE="%BUILD_TYPE%" -DCMAKE_INSTALL_PREFIX="%PREFIX_PATH%" -DBUILD_SHARED_LIBS=ON -DBUILD_TESTS=OFF -DENABLE_AVX=ON -DENABLE_AVX2=ON -DENABLE_SSE=ON -DENABLE_SSE2=ON -DENABLE_THREADS=ON -DWITH_COMBINED_THREADS=ON || goto end
cmake --build . || goto end
cmake --install . || goto end
...
cd "%BUILD_PATH%"
if not exist "glib-2.72.1" 7z x "%SOURCES_PATH%\glib-2.72.1.tar.xz" -so | 7z x -aoa -si"glib-2.72.1.tar" || goto end
cd "glib-2.72.1" || goto end
...
cd "%BUILD_PATH%"
if not exist "glib-networking-2.72.0" 7z x "%SOURCES_PATH%\glib-networking-2.72.0.tar.xz" -so | 7z x -aoa -si"glib-networking-2.72.0.tar" || goto end
cd "glib-networking-2.72.0" || goto end
patch -p1 -N < "%SOURCES_PATH%/glib-networking-tests.patch"
...
cd "%BUILD_PATH%"
if not exist "libpsl-0.21.1" tar -xvf "%SOURCES_PATH%\libpsl-0.21.1.tar.gz" || goto end
...
cd "%BUILD_PATH%"
if not exist "libsoup-2.74.2" 7z x "%SOURCES_PATH%\libsoup-2.74.2.tar.xz" -so | 7z x -aoa -si"libsoup-2.74.2.tar" || goto end
...
cd "%BUILD_PATH%"
if not exist "orc-0.4.32" 7z x "%SOURCES_PATH%\orc-0.4.32.tar.xz" -so | 7z x -aoa -si"orc-0.4.32.tar" || goto end
...
cd "%BUILD_PATH%"
if not exist "musepack_src_r475" tar -xvf "%SOURCES_PATH%\musepack_src_r475.tar.gz" || goto end
cd "musepack_src_r475" || goto end
patch -p1 -N < "%SOURCES_PATH%\musepack-fixes.patch"
if not exist build mkdir build || goto end
cd build || goto end
...
if not exist "libopenmpt" @(
  ...
  7z x "%SOURCES_PATH%\libopenmpt-0.6.2+release.msvc.zip" || goto end
  cd ..
 ) || goto end
cd "libopenmpt" || goto end
patch -p1 -N < "%SOURCES_PATH%\libopenmpt-cmake.patch"
if not exist build2 mkdir build2 || goto end
cd build2 || goto end
cmake .. -G "NMake Makefiles" -DCMAKE_BUILD_TYPE="%BUILD_TYPE%" -DCMAKE_INSTALL_PREFIX=%PREFIX_PATH% -DBUILD_SHARED_LIBS=ON || goto end
cmake --build . || goto end
...
cd "%BUILD_PATH%"
if not exist "fdk-aac-2.0.2" tar -xvf "%SOURCES_PATH%\fdk-aac-2.0.2.tar.gz" || goto end
...
if not exist "faad2" @(
  ...
  cd "faad2" || goto end
  xcopy /s /y /h "%SOURCES_PATH%\faad2" . || goto end
  cd ..
 ) || goto end
cd "faad2" || goto end
patch -p1 -N < "%SOURCES_PATH%\faad2-cmake.patch"
if not exist build mkdir build || goto end
cd build || goto end
cmake .. -G "NMake Makefiles" -DCMAKE_BUILD_TYPE="%BUILD_TYPE%" -DCMAKE_INSTALL_PREFIX=%PREFIX_PATH% -DBUILD_SHARED_LIBS=ON || goto end
cmake --build . || goto end
...
if not exist "faac" @(
  mkdir "faac" || goto end
  cd "faac" || goto end
  xcopy /s /y /h "%SOURCES_PATH%\faac" . || goto end
  cd ..
 ) || goto end
cd faac
patch -p1 -N < "%SOURCES_PATH%\faac-msvc.patch"
...
cd "%BUILD_PATH%"
if not exist "libbs2b-3.1.0" tar -xvf "%SOURCES_PATH%\libbs2b-3.1.0.tar.bz2" || goto end
cd "libbs2b-3.1.0" || goto end
patch -p1 -N < "%SOURCES_PATH%\libbs2b-msvc.patch"
if not exist build mkdir build || goto end
cd build || goto end
cmake .. -G "NMake Makefiles" -DCMAKE_BUILD_TYPE="%BUILD_TYPE%" -DCMAKE_INSTALL_PREFIX=%PREFIX_PATH% -DBUILD_SHARED_LIBS=ON || goto end
cmake --build . || goto end
...
cd "%BUILD_PATH%"
if not exist "gstreamer-1.20.1" 7z x "%SOURCES_PATH%\gstreamer-1.20.1.tar.xz" -so | 7z x -aoa -si"gstreamer-1.20.1.tar" || goto end
cd "gstreamer-1.20.1" || goto end
if not exist "build\build.ninja" meson --buildtype="%BUILD_TYPE%" --prefix=%PREFIX_PATH% --pkg-config-path=%PREFIX_PATH%\lib\pkgconfig build || goto end
cd build || goto end
ninja || goto end
ninja install || goto end
...
cd "%BUILD_PATH%"
if not exist "gst-plugins-base-1.20.1" 7z x "%SOURCES_PATH%\gst-plugins-base-1.20.1.tar.xz" -so | 7z x -aoa -si"gst-plugins-base-1.20.1.tar" || goto end
cd "gst-plugins-base-1.20.1" || goto end
...
cd "%BUILD_PATH%"
if not exist "gst-plugins-good-1.20.1" 7z x "%SOURCES_PATH%\gst-plugins-good-1.20.1.tar.xz" -so | 7z x -aoa -si"gst-plugins-good-1.20.1.tar" || goto end
cd "gst-plugins-good-1.20.1" || goto end
...
cd "%BUILD_PATH%"
if not exist "gst-plugins-bad-1.20.1" 7z x "%SOURCES_PATH%\gst-plugins-bad-1.20.1.tar.xz" -so | 7z x -aoa -si"gst-plugins-bad-1.20.1.tar" || goto end
cd "gst-plugins-bad-1.20.1" || goto end
patch -p1 -N < "%SOURCES_PATH%\gst-plugins-bad-libpaths.patch"
...
cd "%BUILD_PATH%"
if not exist "protobuf-3.20.0" tar -xvf "%SOURCES_PATH%\protobuf-cpp-3.20.0.tar.gz" || goto end
cd "protobuf-3.20.0\cmake" || goto end
if not exist build mkdir build || goto end
cd build || goto end
...
cd "%BUILD_PATH%"
if not exist "expat-2.4.8" tar -xvf "%SOURCES_PATH%\expat-2.4.8.tar.bz2" || goto end
cd "expat" || goto end
if not exist build mkdir build || goto end
cd build || goto end
...
cd "%BUILD_PATH%"
if not exist "freetype-2.12.0" tar -xvf "%SOURCES_PATH%\freetype-2.12.0.tar.bz2" || goto end
...
cd "%BUILD_PATH%"
if not exist "harfbuzz-4.2.0" tar -xvf "%SOURCES_PATH%\harfbuzz-4.2.0.tar.bz2" || goto end
...
cd "%BUILD_PATH%"
if not exist "qtbase-everywhere-src-6.3.0" 7z x "%SOURCES_PATH%\qtbase-everywhere-src-6.3.0.tar.xz" -so | 7z x -aoa -si"qtbase-everywhere-src-6.3.0.tar" || goto end
cd "qtbase-everywhere-src-6.3.0" || goto end
patch -p1 -N < "%SOURCES_PATH%/qtbase-pcre2.patch"
if not exist build mkdir build || goto end
cd build || goto end
...
cd "%BUILD_PATH%"
if not exist "qttools-everywhere-src-6.3.0" 7z x "%SOURCES_PATH%\qttools-everywhere-src-6.3.0.tar.xz" -so | 7z x -aoa -si"qttools-everywhere-src-6.3.0.tar" || goto end
cd "qttools-everywhere-src-6.3.0" || goto end
if not exist build mkdir build || goto end
cd build || goto end
...
if not exist "qtsparkle" @(
  ...
  xcopy /s /y /h "%SOURCES_PATH%\qtsparkle" . || goto end
  cd ..
 ) || goto end
cd "qtsparkle" || goto end
patch -p1 -N < "%SOURCES_PATH%/qtsparkle-msvc.patch"
if not exist build mkdir build || goto end
cd build || goto end
...
if not exist "strawberry" @(
  ...
  xcopy /s /y /h "%SOURCES_PATH%\strawberry" . || goto end
  cd ..
 ) || goto end
cd "strawberry" || goto end
if not exist build mkdir build || goto end
cd build || goto end
cmake .. -G "NMake Makefiles" -DCMAKE_BUILD_TYPE="%BUILD_TYPE%" -DBUILD_WITH_QT6=ON -DCMAKE_PREFIX_PATH="%PREFIX_PATH%\lib\cmake" -DCMAKE_INSTALL_PREFIX="%PREFIX_PATH%" -DARCH=x86_64 || goto end
cmake --build . || goto end
cmake --install . || goto end
